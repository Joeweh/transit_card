...
class _HomePageState extends State<HomePage> {
  final List<Color> _colors = [ Colors.green, Colors.red, Colors.blue ];
  final List<String> _titles = [ "MBTA 505236", "SQ*MAMACITAS AUT...", "CalTrain 8694035" ];
  final List<String> _costs = [ "\$2.40", "\$13.38", "\$4.80" ];
